...
from models import Discriminator, LeNetClassifier, LeNetEncoder, Baseline, CORAL
...
if __name__ == '__main__':
    ...
    if not os.path.isfile('snapshots//src-baseline-final.pt'):
    ...
    print(tgt_baseline)
    if not os.path.isfile('snapshots//tgt-baseline-final.pt'):
